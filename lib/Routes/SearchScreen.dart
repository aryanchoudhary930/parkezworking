...
import 'package:parkezze/flutter_counter.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  var _selectedPeriod = dp.DatePeriod(DateTime.now().add(Duration(days: 4)),
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[Text("Filtrer"), Icon(Icons.apps)],
                      ),
                    ),
                  ),
                ),
  ...
  dp.DatePickerRangeStyles styles = dp.DatePickerRangeStyles(
    ...
    selectedPeriodMiddleDecoration:
        BoxDecoration(color: Constants.greenParkz, shape: BoxShape.rectangle),
